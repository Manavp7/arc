/** Shared serialized response contracts used by the SDK and console.
 * API defaults (IDs, arrays, timestamps) are materialized in responses; generated
 * OpenAPI input schemas mark several of these optional. Keep response contracts here. */
